...
BookingRouter.post('/booking', async (req, res) => {
    ...
    if (!user || !flight) 
    return res.send({ msg: 'Please Provide The User And Flight ID ( user, flight )' })
    try {
...
// http://localhost:3000/api/booking --- POST
// http://localhost:3000/api/dashboard ---- GET
// http://localhost:3000/api/dashboard/65eee0a357efa1d27f4c7fb2 ---- dashboard/id/Patch/delete
